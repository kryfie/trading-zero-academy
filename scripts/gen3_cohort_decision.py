...
target = int(os.environ.get("COHORT_TARGET_TIMESTEPS", "1000000000"))
...
if target != 1_000_000_000:
    raise SystemExit("Generation 3 protocol is frozen at a 1B target.")
if student_count != 8:
    raise SystemExit("Generation 3 protocol is frozen at exactly 8 students.")
summaries = []
...
print(f"Generation 3 target/student: {target:,}")
